...
`docker run --name db -d --rm -v c:/Projects/Test.InteliJ_IDEA.Java/db/data:/var/lib/postgresql/data -e TZ=Asia/Novosibirsk -e POSTGRES_PASSWORD=password postgres`
...
`docker run --name db -d --rm -v c:/Projects/Test.InteliJ_IDEA.Java/db/data:/var/lib/postgresql/data -v c:/Projects/Test.InteliJ_IDEA.Java/db/scripts:/etc/postgresql/scripts -e TZ=Asia/Novosibirsk -e POSTGRES_PASSWORD=password postgres`
